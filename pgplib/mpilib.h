...
/* We'll pull in the assembler code here if asked to. */
#ifdef WIN32
...
#ifndef mp_move
#define mp_move(d, s) memcpy((void *)(d), (void *)(s), units2bytes(global_precision))
#endif
#ifndef unitfill0
