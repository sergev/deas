...
int rsa_private_encrypt(unitptr outbuf, byteptr inbuf, short bytes, unitptr E, unitptr D, unitptr P,
                        unitptr Q, unitptr U, unitptr N)
 ...
 */
{
     ...
     */
    if (back[-1] == MD_ENCRYPTED_BYTE && back[-17] == 0xff && back[-18] == 0xff) {
...
int rsa_private_decrypt(byteptr outbuf, unitptr inbuf, unitptr E, unitptr D, unitptr P, unitptr Q,
                        unitptr U, unitptr N)
