...
int private_decrypt(void *from, void *to, int len, char *e, char *d, char *p, char *q, char *u,
                    char *n);
...
int rsa_public_encrypt(unsigned char *outbuf, unsigned char *inbuf, short bytes, unsigned char *E,
                       unsigned char *N);
int rsa_private_decrypt(unsigned char *outbuf, unsigned char *inbuf, unsigned char *E,
                        unsigned char *D, unsigned char *P, unsigned char *Q, unsigned char *U,
                        unsigned char *N);
